...
@Operation(
                                ...
                                examples = @ExampleObject("""
                                        {
                                          ...
                                          "result": {
                                            "path": "PATCH /v1/projects/oGqrBVCEOCzdm5oSpKzU_3aTyf3CJhOjOIfF4Qf6x0MWTU5c1PU3otXdDpmP6R3Y",
        ...
        requestBody = @RequestBody(
                description = "This request comes with a name and/or a type",
                required = true,
                content = @Content(
                        ...
                        examples = {
                                @ExampleObject(
                                        ...
                                        value = """
                                                ...
                                                """),
                                @ExampleObject(
                                        name = "A valid request with a valid body #2",
                                ...
                                @ExampleObject(
                                        name = "A valid request with a valid body #3",
                                        summary = "Valid example #3",
                                        value = """
                                                {
                                                      "type": "Super lux"
                                                }
...
public @interface PatchRequestDocument {
